...
home_class = "nav-button nav-active" if st.session_state.app_mode == "Dashboard" else "nav-button"
quran_class = "nav-button nav-active" if st.session_state.app_mode == "Quran Reader" else "nav-button"
hadith_class = "nav-button nav-active" if st.session_state.app_mode == "Hadith Search" else "nav-button"

if col1.button("🏠 Home", key="home_nav", help="Go to home page"):
st.session_state.app_mode = "Dashboard"
st.rerun()

if col2.button("📖 Quran", key="quran_nav", help="Go to Quran reader"):
st.session_state.app_mode = "Quran Reader"
st.rerun()

if col3.button("📜 Hadith", key="hadith_nav", help="Go to Hadith search"):
