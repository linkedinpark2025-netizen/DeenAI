...
# Initialize session state without if statements
...
.arabic-txt { font-size: 32px; color: #ffffff; text-align: center; direction: rtl; line-height: 1.8; }
...
st.rerun()
if col2.button("📖 Quran"):
st.session_state.app_mode = "Quran Reader"
st.rerun()
if col3.button("📜 Hadith"):
